...
if __name__ == '__main__':
    ...
    flow_cfg = {
        ...
        "MACROS": {**macro_config([
            ("tt_main_macro", "../main", "main_inst", 667.7, 667.7),
            ("tt_cell_macro_0", "../cells/cell0", "cell_inst_0", 667.7, 2313.7),
            ("tt_cell_macro_1", "../cells/cell1", "cell_inst_1", 396.7, 2042.7),
            ("tt_cell_macro_2", "../cells/cell2", "cell_inst_2", 396.7, 667.7),
            ("tt_cell_macro_3", "../cells/cell3", "cell_inst_3", 667.7, 396.7),
            ("tt_cell_macro_4", "../cells/cell4", "cell_inst_4", 2042.7, 396.7),
            ("tt_cell_macro_5", "../cells/cell5", "cell_inst_5", 2313.7, 667.7),
            ("tt_cell_macro_6", "../cells/cell6", "cell_inst_6", 2313.7, 2042.7),
            ("tt_cell_macro_7", "../cells/cell7", "cell_inst_7", 2042.7, 2313.7),
            ("tt_buffer_macro", "../buffer", "buffer_inst", 1104.7, 2463.7),
        ]), **extra_macro_config([
            ("loopback", "macros/loopback", "loop_inst", 1005, 357.66),
            ("tt_logo", "macros/tt_logo", "logo_inst", 2313.7, 396.7),
        ...
        "DIE_AREA": [0.00, 0.00, 2935.00, 2935.00],
        "CORE_AREA": [414.82, 414.82, 2520.18, 2520.18],
        "FP_SIZING" : "absolute",
