...
if __name__ == '__main__':
    ...
    flow_cfg = {
        ...
        "PDN_MACRO_CONNECTIONS": [
            "main_inst vddcore[0] vss VDD VSS",
            "cell_inst_0 vddcore[1] vss VDD VSS",
            "cell_inst_1 vddcore[1] vss VDD VSS",
            "cell_inst_2 vddcore[2] vss VDD VSS",
            "cell_inst_3 vddcore[2] vss VDD VSS",
            "cell_inst_4 vddcore[3] vss VDD VSS",
            "cell_inst_5 vddcore[3] vss VDD VSS",
            "cell_inst_6 vddcore[4] vss VDD VSS",
            "cell_inst_7 vddcore[4] vss VDD VSS",
        ],
